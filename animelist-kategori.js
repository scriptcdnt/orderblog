    ...
    function b() {
        if ("entry" in a.feed) {
            ...
            for (var h = 0; h < d; h++) {
                ...
                var j;
                for (var g = 0; g < n.link.length; g++) { if (n.link[g].rel == "alternate") { j = n.link[g].href; break } }
                var o = "";
                for (var g = 0; g < n.link.length; g++) { if (n.link[g].rel == "enclosure") { o = n.link[g].href; break } }
                var c = "";
                if ("category" in n) {
...
function sortPosts(d) {
    ...
    for (var b = 0; b < postTitle.length - 1; b++) { for (var a = b + 1; a < postTitle.length; a++) { if (d == "titleasc") { if (postTitle[b] > postTitle[a]) { c(b, a) } } if (d == "titledesc") { if (postTitle[b] < postTitle[a]) { c(b, a) } } if (d == "dateoldest") { if (postDate[b] > postDate[a]) { c(b, a) } } if (d == "datenewest") { if (postDate[b] < postDate[a]) { c(b, a) } } if (d == "orderlabel") { if (postLabels[b] > postLabels[a]) { c(b, a) } } } }
}
...
function displayToc(a) {
    ...
    if (postFilter != "") { j = "Klik untuk menampilkan semua" }
    h += "<table>";
    h += "<tr>";
...
function displayToc2() {
    ...
    while (b < postTitle.length) {
        temp1 = postLabels[b];
        document.write("<p/>");
        document.write('<div class="header-atasan"><a href="/search/label/' + temp1 + '">' + temp1 + "</a></div>");
        firsti = a;
        do {
            document.write("");
            document.write('<a class="link-animelist" title="' + postTitle[a] + '" href="' + postUrl[a] + '">' + postTitle[a] + "</a>");
            if (postBaru[a] == true) { document.write(' ') }
            document.write("");
            a = a + 1
...
function showToc() { if (tocLoaded) { displayToc(postFilter); var a = document.getElementById("toclink") } else { alert("Just wait... TOC is loading") } }
